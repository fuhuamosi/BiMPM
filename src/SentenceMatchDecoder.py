...
if __name__ == '__main__':
    ...
    parser.add_argument('--word_vec_path', type=str, required=True,
    ...
    if hasattr(FLAGS,
               'wo_max_attentive_match'): wo_max_attentive_match = FLAGS.wo_max_attentive_match
